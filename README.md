# ✨ successful-coriander-jekyll-sanity ✨
...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://vitaliy-stackbit.ngrok.io/pull/5feb1ae1da995148ea0bdaca
...
To start editing your site, you can use the Sanity interface at https://successful-coriander-jekyll-sanity-b1ae1.sanity.studio/.
...
Generated at `2020-12-29T12:03:03.032Z` by Stackbit version `0.3.42`.